...
python scripts/subensemble_pipeline.py $name --autoenc --sample --n_labeled $n_labeled --epochs_labeled $epochs_labeled --epochs_unlabeled $epochs_unlabeled --n_unlabeled $n_unlabeled
echo "completed running subensemble with normal autoencoder and ensemble sampling"
clean_datadirs
python scripts/subensemble_pipeline.py $name --autoenc --n_labeled $n_labeled --epochs_labeled $epochs_labeled --epochs_unlabeled $epochs_unlabeled --n_unlabeled $n_unlabeled
...
python scripts/subensemble_pipeline.py $name --autoenc --denoising --sample --n_labeled $n_labeled --epochs_labeled $epochs_labeled --epochs_unlabeled $epochs_unlabeled --n_unlabeled $n_unlabeled
echo "completed running subensemble with denoising autoencoder and sampling"
clean_datadirs
python scripts/subensemble_pipeline.py $name --autoenc --denoising --n_labeled $n_labeled --epochs_labeled $epochs_labeled --epochs_unlabeled $epochs_unlabeled --n_unlabeled $n_unlabeled
...
python scripts/baseline_ae.py $name --n_labeled $n_labeled --epochs_labeled $epochs_labeled --epochs_unlabeled $epochs_unlabeled --n_unlabeled $n_unlabeled
clean_datadirs

# run baseline - denoising autoencoder
python scripts/baseline_ae.py $name --denoising --n_labeled $n_labeled --epochs_labeled $epochs_labeled --epochs_unlabeled $epochs_unlabeled --n_unlabeled $n_unlabeled
clean_datadirs
